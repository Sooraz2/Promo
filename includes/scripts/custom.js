jQuery(document).ready(function () {
    ...
    function responsive() {
        ...
        if(!jQuery('.mainwrapper').hasClass("no-responsive")) {
            ...
            jQuery('.mainwrapper').css('width', "auto");

            jQuery('.rightpanel').css('min-width', "0");

            if(windowWidth > 909 && windowWidth < 1024)
                jQuery('.rightpanel').css('width', windowWidth - jQuery(".leftpanel").width());
            else
                jQuery('.rightpanel').css('width', "auto");


            jQuery('.footer').css('min-width', "0");
            jQuery('.footer').css('max-width', "none");
        }
