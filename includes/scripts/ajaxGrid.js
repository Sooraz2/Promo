        ...
        return this.each(function () {
            ...
            var self = {
                initialize: function () {
                    ...
                    $table.on("changePageSize", function(event, pageSize){
                        ...
                        $table.find('thead th').each(function () {
                            ...
                            if ($(this).find('a').length != 0) {
                                ...
                                if (options.contentAdditionalProperty != null && self.compareObjectValue(options.contentAdditionalProperty, $(this).find('a').attr('field-name'))) {
                                    ...
                                    if(options.translateColumn!=null && $(this).find('a').attr('field-name') == options.translateColumn){
                                        $td.html(InterfaceLanguage[item[$(this).find('a').attr('field-name')]]);
                                    }else{
                ...
                createPaging: function (rowCount, pageNumber, pageSize) {
                    ...
                    } else if (parseInt(rowCount) > parseInt(options.pageSize)) {
                        $table.after(pageUl);
