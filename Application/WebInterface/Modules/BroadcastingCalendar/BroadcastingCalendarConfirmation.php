...
class BroadcastingCalendarConfirmation
{
    ...
    public static function Update($status)
    {
        ...
        $confirmationMessage->Message = $status ? $confirmationMessage->language->SuccessfullyUpdatedPromotion :$confirmationMessage->language->FailedUpdatingBlacklist ;
