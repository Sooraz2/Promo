...
class OperatorConfirmation
{
    ...
    public static function Save($status)
    {
        ...
        $confirmationMessage->Message = $status ? $confirmationMessage->language->SuccessfullySavedOperator :$confirmationMessage->language->FailedSaving ;
    ...
    public static function Update($status)
    {
        ...
        $confirmationMessage->Message = $status ? $confirmationMessage->language->SuccessfullyUpdatedOperator :$confirmationMessage->language->FailedUpdating ;
