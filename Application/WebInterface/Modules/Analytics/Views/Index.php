...
<li class='active'>{$Language->translate('Analytics')}</li>";

$PageTitle = $Language->translate('Analytics');
            ...
            <div class="row-fluid">
                ...
                <div class="" style="margin-bottom: 20px">
                    <form method="POST" class="form-inline form-inline-ie" id="Analytics-Form"
                          action="<?php echo BASE_URL . "Analytics/Export" ?>">
            ...
            <span class="input-group-addon" style="color: #2D94DA;"><i class="fa fa-calendar"
                        ...
                        <div class="form-group" style="margin-left: 15px">
                            <select class="form-control" name="PromotionList" id="PromotionList"
								...
								<option>ICB Broadcaster</option>
                                <option>SMS Broadcast</option>
                                <option>SNS</option>
                                <option>Wrong IVR</option>
                                <option>Wrong Star(*)</option>
                    ...
                    <table id="Analytics-Report-List" class="table table-bordered table-sorted">
                        ...
                        <tr>
                            ...
                            <th><a class="table-header"
                                   field-name="Promotion"><?php echo $Language->translate("Promotion") ?></a></th>
                            <th><a class="table-header"
                            ...
                            <th><a class="table-header"
                                   field-name="Views1"><?php echo $Language->translate("Views") ?></a></th>
                           <!-- <th><a class="table-header" field-name="Activation"><?php /*echo $Language->translate("Activations") */?></a></th>-->
                            <th><a class="table-header" field-name="Activation1"><?php echo $Language->translate("Activations") ?></a></th>


                            <th><a class="table-header"
                                   field-name="ActivationPercent"><?php echo $Language->translate("Activations, %") ?></a>
                            </th>
                            <th><a class="table-header"
                                   field-name="comments"><?php echo $Language->translate("Comments") ?></a>
                            </th>
                            <!--                            <th width="400px">-->
                            <?php //echo  $Language->translate("Action") ?><!--</th>-->
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
//                        $AnalyticsReportList.trigger('refreshGrid', $reportSearchForm.serializeObject());
                    }
                }
        ...
        $('#Analytics-Report-List').ajaxGrid({
            ...
            url: '<?php echo  BASE_URL ?>Analytics/GetAll',
        ...
        $('#ExportButton').on('click', function () {
            ...
            var DateFromExport = $('#DateFrom').val();
            var DateToExport = $('#DateTo').val();
            var CountryExport = GetCountryList('Name');
            var OperatorExport = GetOperatorList('Name');
            var ServiceExport = GetServiceList('Name');
            var PromotionExport = $('#PromotionList').val();

            $.ajax({
                url: "<?php echo BASE_URL ?>Analytics/Export",
                type: "GET",
                data: {
                    "DateFromExport": DateFromExport,
