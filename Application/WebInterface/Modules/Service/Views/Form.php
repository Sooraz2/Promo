...
<form action="<?php echo BASE_URL . "Service/SaveUpdate" ?>" id="service-form" method="post"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div id="first_date_picker_container" data-relation="first" class="date-container">
                <input type="text" name="name" id="Date-BroadCast" value="<?php echo $name ?>" class="form-control validate[required,ajax[ajaxServiceNameCheck]]">
            </div>
