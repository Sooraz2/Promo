...
class CountryConfirmation
{
    ...
    public static function Save($status)
    {
        ...
        $confirmationMessage->Message = $status ? $confirmationMessage->language->SuccessfullySavedCountry :$confirmationMessage->language->FailedSaving ;
    ...
    public static function Update($status)
    {
        ...
        $confirmationMessage->Message = $status ? $confirmationMessage->language->SuccessfullyUpdatedCountry :$confirmationMessage->language->FailedUpdating ;
